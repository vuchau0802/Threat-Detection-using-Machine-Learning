...
## Features    
- Achieves **96% prediction accuracy** using ML regression models on 72,000+ labeled texts.  
- Engineered semantic, syntactic, and sentiment features, increasing classifier performance .  
- Built a real-time moderation interface using Flask, generating severity scores and reducing review time.
